...
from core.models import Catagories, Partner, Feedback
...
class LoginView(FormView):
    ...
    def dispatch(self, request, *args, **kwargs):
        if self.request.user.is_superuser == True:
            return HttpResponseRedirect(reverse("common:dashboard"))
    ...
    def form_valid(self, form):
        user = EmailBackEnd.authenticate(self.request, username=self.request.POST.get('email'), password=self.request.POST.get('password'))
